...
namespace Crackbox
{
    public class CrackboxLogic
    {
        public static IList<CrackboxGridItem> CreateGrid()
        {
            ...
            {
                CrackboxGridItem.Create(0, 4, 12, 3, 1, new[] { 1, 4, 5 } ),
                CrackboxGridItem.Create(1, 5, 13, 0, 2, new[] { 0, 2, 4, 5, 6 }),
                CrackboxGridItem.Create(2, 6, 14, 1, 3, new[] { 1, 3, 5, 6, 7 }),
                CrackboxGridItem.Create(3, 7, 15, 2, 0, new[] { 2, 6, 7}),
                CrackboxGridItem.Create(4, 8, 0, 7, 5, new[] { 0, 1, 5, 8, 9}),
                CrackboxGridItem.Create(5, 9, 1, 4, 6, new[] { 0, 1, 2, 4, 6, 8, 9, 10}),
                CrackboxGridItem.Create(6, 10, 2, 5, 7, new[] { 1, 2, 3, 5, 7, 9, 10, 11}),
                CrackboxGridItem.Create(7, 11, 3, 6, 4, new[] { 2, 3, 6, 10, 11}),
                CrackboxGridItem.Create(8, 12, 4, 11, 9, new[] { 4, 5, 9, 12, 13}),
                CrackboxGridItem.Create(9, 13, 5, 8, 10, new[] { 4, 5, 6, 8, 10, 12, 13, 14}),
                CrackboxGridItem.Create(10, 14, 6, 9, 11, new[] { 5, 6, 7, 9, 11, 13, 14, 15}),
                CrackboxGridItem.Create(11, 15, 7, 10, 8, new [] { 6, 7, 10, 14, 15}),
                CrackboxGridItem.Create(12, 0, 8, 15, 13, new[] { 8, 9, 13}),
                CrackboxGridItem.Create(13, 1, 9, 12, 14, new[] { 8, 9, 10, 12, 14}),
                CrackboxGridItem.Create(14, 2, 10, 13, 15, new[] { 9, 10, 11, 13, 15}),
                CrackboxGridItem.Create(15, 3, 11, 14, 12, new[] { 10, 11, 14})
            };
        }
